...
def get_habr_snippets():
    ...
    if html:
        ...
        all_news = soup.find('ul', class_='content-list content-list_posts shortcuts_items').findAll('li', class_='content-list__item content-list__item_post shortcuts_item')
